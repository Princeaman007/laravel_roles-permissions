...
<div class="container py-5">
    ...
    @php
    $hasStockError = $cartItems->contains(fn($item) => $item->quantity > $item->product->stock || $item->product->stock
    === 0);
    @endphp
                            ...
                            <div class="d-flex align-items-start">
                                ...
                                <div>
                                    ...
                                    <div class="text-warning small mt-1">
                                        ⚠️ Vous avez demandé {{ $item->quantity }}, mais il n'en reste que {{
                                        $item->product->stock }} en stock.
                                    </div>
                                    @elseif($item->product->stock === 1)
                                    <div class="text-warning small mt-1">
                                        🔥 Il ne reste qu’<strong>1</strong> exemplaire !
                                    </div>
                                    @else
                        ...
                        <td>
                            <form action="{{ route('cart.update') }}" method="POST" class="d-inline">
                                ...
                                <div class="input-group">
                                    <input type="number" name="items[0][quantity]" value="{{ $item->quantity }}" min="1"
                                        class="form-control">
            ...
            <div class="card shadow-sm">
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between mb-2">
                        ...
                        <span>{{ number_format($totals['shipping_cost'], 2) }} €</span>
                    </div>
                    @endif
